...
public class Matrix_driver {
    ...
    private static void escriu_matriu(Matrix m) {
        for (int i : m.rows()) {
            m.getRow(i).forEach(v -> {
                System.out.println(" Fila " + i + ", columna " + v.getSecond() + ", valor: " + v.getValue());
            });
        }
    }
    ...
    public static void main(String[] args) {
        ...
        list.forEach(p -> System.out.println("Columna: " + p.getSecond() + " Valor: " + p.getValue()));
